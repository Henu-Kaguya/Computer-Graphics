...
* A. `glShadingModel(GL_FLAT);`
* B. `glShadingModel(GL_SMOOTH);`
* C. `glShadingModel(GL_SMOOTH_SHADE);`
...
* A. `glRectf(25.0f, 25.0f, 75.0f, 75.0f);`
* B. `glDrawRect(25, 25, 75, 75);`
* C. `glBegin(GL_QUADS);`
* D. `glViewport(25, 25, 75, 75);`

**10. (10) 处绘制顶点的坐标代码为：（　　）**

* A. `glVertex3f(0.0, 0.0, 0.0);`
* B. `glVertex2f(0.0f, 0.0f);`
* C. `glVertex2i(0, 0);`
* D. `以上均可`
