...
A）`glTexImage2D`　　B）`glTexImage1D`　　C）`glTexEnvf`　　D）`glGenTextures`
...
A）`glTexCoord2f(0.0f, 0.0f);`　　B）`glTexCoord2f(0.0f, 1.0f);`  
C）`glVertex2f(0.0f, 0.0f);`　　D）`glTexCoord2f(1.0f, 1.0f);`

**4.** (4) 处需要填入的指定右下角纹理坐标的代码为：（　　）

A）`glTexCoord2f(0.0f, 1.0f);`　　B）`glTexCoord2f(1.0f, 0.0f);`  
C）`glTexCoord2f(1.0f, 1.0f);`　　D）`glTexCoord2f(0.0f, 0.0f);`
...
A）`glTexCoord2f`　　B）`glMultiTexCoord2f`  
C）`glMultiTexCoord2d`　　D）`glActiveTexture`

**10.** (10) 处指定多重纹理坐标单元 1 映射坐标的函数名为：（　　）

A）`glTexCoord2f`　　B）`glMultiTexCoord2f`  
C）`glMultiTexCoord2i`　　D）`glActiveTexture`
...
A）`glTexCoord2f`　　B）`glMultiTexCoord2f`  
C）`glActiveTexture`　　D）`glMultiTexCoord2d`
