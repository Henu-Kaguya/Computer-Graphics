...
| :------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------: |
| **原始方程与距离表示**                |             $F(x,y) = \Delta y \cdot x - \Delta x \cdot y + C = 0$（其中 $A = \Delta y, B = -\Delta x$）             |                 $y = k(x - x_0) + y_0$$d_{\text{down}} = y - y_i,\quad d_{\text{up}} = (y_i + 1) - y$                 |
| **整数判别式初值**                    |                                              $d_0 = \Delta x - 2\Delta y$                                              |                                               $p_0 = 2\Delta y - \Delta x$                                               |
| **判别式符号含义**                    | $d < 0$：中点在直线下方 $\rightarrow$ 选上方 $P_2$$d \ge 0$：中点在直线上方或线上 $\rightarrow$ 选下方 $P_1$ | $p \ge 0$：直线更靠近上方像素 $\rightarrow$ 选上方 $P_2$$p < 0$：直线更靠近下方像素 $\rightarrow$ 选下方 $P_1$ |
